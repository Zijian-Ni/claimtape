...
export const i18n = {
  en: {
    ...
    shareTooLong: 'This report is too large for a URL (limit 8000 characters). Download the report instead — we will not silently truncate your evidence.',
    shareDownloadInstead: 'Download report',
    shareBanner: 'Shared report — read only. Coverage still means evidence match, not truth.',
    redactedCount: 'Redacted {n} items before sharing.',
    copied: 'Copied!',
    ...
    how4: 'Copy a Markdown report or a shareable link',
    claimNumber: 'Claim',
  ...
  zh: {
    ...
    shareLink: '复制分享链接',
    shareCopied: '分享链接已复制',
    shareTooLong: '这份报告太大，放不进 URL（上限 8000 字符）。请改为下载报告——我们不会悄悄截断你的证据。',
    shareDownloadInstead: '下载报告',
    shareBanner: '这是一份分享报告，只读。覆盖率衡量的仍是证据匹配，不是事实真伪。',
    redactedCount: '分享前已脱敏 {n} 处。',
    copied: '已复制！',
    downloaded: '已下载！',
    claimsTitle: '声明分析',
    riskTitle: '风险标记',
